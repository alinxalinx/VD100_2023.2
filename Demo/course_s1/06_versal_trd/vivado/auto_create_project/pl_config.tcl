  ...
  # Create instance: rst_gpio, and set properties
  set rst_gpio [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 rst_gpio ]
  set_property -dict [list \
  ...
  connect_bd_intf_net -intf_net CLK_IN_D_0_2 [get_bd_intf_ports lcd_ref] [get_bd_intf_pins util_ds_buf_1/CLK_IN_D]
  ...
  connect_bd_intf_net -intf_net axi_smc_M04_AXI [get_bd_intf_pins axi_smc/M04_AXI] [get_bd_intf_pins v_demosaic_1/s_axi_CTRL]
  connect_bd_intf_net -intf_net axi_smc_M05_AXI [get_bd_intf_pins axi_smc/M05_AXI] [get_bd_intf_pins v_tc_0/ctrl]
  connect_bd_intf_net -intf_net axi_smc_M06_AXI [get_bd_intf_pins axi_smc/M06_AXI] [get_bd_intf_pins rst_gpio/S_AXI]
  ...
  connect_bd_intf_net -intf_net v_axi4s_vid_out_0_vid_io_out [get_bd_intf_pins v_axi4s_vid_out_0/vid_io_out] [get_bd_intf_pins lcd_lvds_0/lcd_vid_io]
  ...
  connect_bd_net -net rst_clk_wizard_0_150M_peripheral_aresetn [get_bd_pins rst_clk_wizard_0_150M/peripheral_aresetn] [get_bd_pins v_tc_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins axi_vdma_1/axi_resetn] [get_bd_pins mipi_csi2_rx_subsyst_0/video_aresetn] [get_bd_pins mipi_csi2_rx_subsyst_1/video_aresetn] [get_bd_pins axi_vdma_2/axi_resetn] [get_bd_pins axis_subset_converter_0/aresetn] [get_bd_pins axis_subset_converter_1/aresetn] [get_bd_pins rst_gpio/s_axi_aresetn]
  connect_bd_net -net rst_gpio_gpio2_io_o [get_bd_pins rst_gpio/gpio2_io_o] [get_bd_pins v_demosaic_1/ap_rst_n]
  connect_bd_net -net rst_gpio_gpio_io_o [get_bd_pins rst_gpio/gpio_io_o] [get_bd_pins v_demosaic_0/ap_rst_n]
  ...
  connect_bd_net -net xlconstant_0_dout_1 [get_bd_pins constant_gnd/dout] [get_bd_pins lcd_lvds_0/mode] [get_bd_pins advanced_io_wizard_0/t_Data_pins_0] [get_bd_pins advanced_io_wizard_0/t_Data_pins_1] [get_bd_pins advanced_io_wizard_0/t_Data_pins_2] [get_bd_pins advanced_io_wizard_0/t_Data_pins_3] [get_bd_pins advanced_io_wizard_0/t_Data_pins_4]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins xlconstant_1/dout] [get_bd_ports lcd_sync]
  connect_bd_net -net xlconstant_1_dout_1 [get_bd_pins constant_vcc/dout] [get_bd_pins advanced_io_wizard_0/en_vtc]
  connect_bd_net -net xlconstant_2_dout [get_bd_pins xlconstant_2/dout] [get_bd_pins mipi_csi2_rx_subsyst_1/ctrl_core_en] [get_bd_pins mipi_csi2_rx_subsyst_0/ctrl_core_en]
  connect_bd_net -net xlconstant_3_dout [get_bd_pins xlconstant_3/dout] [get_bd_pins mipi_csi2_rx_subsyst_1/active_lanes] [get_bd_pins mipi_csi2_rx_subsyst_0/active_lanes]
  ...
  group_bd_cells lvds_group [get_bd_cells util_vector_logic_0] [get_bd_cells xlconstant_0] [get_bd_cells util_vector_logic_1] [get_bd_cells xlconstant_1] [get_bd_cells constant_vcc] [get_bd_cells xlslice_4] [get_bd_cells advanced_io_wizard_0] [get_bd_cells xlslice_5] [get_bd_cells xlslice_6] [get_bd_cells lcd_lvds_0] [get_bd_cells xlslice_7] [get_bd_cells constant_gnd]
  ...
  assign_bd_address -offset 0x80030000 -range 0x00010000 -target_address_space [get_bd_addr_spaces versal_cips_0/M_AXI_LPD] [get_bd_addr_segs rst_gpio/S_AXI/Reg] -force
